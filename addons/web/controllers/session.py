...
class Session(http.Controller):
    ...
    def logout(self, redirect='/web'):
        logging.info('------incoming===============%s',request,request.session)
        logging.info('------request.session.uid===============%s',request.session.uid)
        logging.info('------request.session.sid===============%s',request.session.sid)
